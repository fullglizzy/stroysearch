...
// Полный классификатор в виде строк (каждая строка = пункт дерева)
// Формат: "номер название" — номер определяет уровень вложенности
const CLASSIFIER = `
...
2.5. Проектирование стадия "РД"
2.5.1. АР (Архитектурные решения)
2.5.2. Конструктивные решения (КР)
2.5.2.1. Конструкции металлические (КМ)
2.5.2.2. Конструкции железобетонные (КЖ)
2.5.3. ГПЗУ
2.5.4. Инженерное оборудование (ИОС)
2.5.4.1. ОВиК
2.5.4.1.1. Отопление
2.5.4.1.2. Вентиляция
2.5.4.1.3. Кондиционирование
2.5.4.2. ВК
2.5.4.2.1. Водоснабжение
2.5.4.2.1.1. Внешнее водоснабжение
2.5.4.2.1.2. Внутреннее водоснабжение
2.5.4.2.2. Канализация (водоотведение)
2.5.4.2.2.1. Внешняя канализация
2.5.4.2.2.2. Внутренняя канализация
2.5.4.3. Проектирование СС
2.5.4.4. Проектирование ЭОМ
2.5.4.5. Проектирование Система безопасности
2.5.4.6. Проектирование Лифты
2.5.4.7. Проектирование Мусоропровод
2.5.4.8. Проектирование Газификация
2.5.4.9. Проектирование Пожарная безопасность
2.5.4.10. Проектирование Молниезащита
2.5.5. АИ-Р (архитектурные интерьеры)
2.5.6. Проектирование благоустройства территории
2.5.7. Услуги лабораторий
2.5.8. Авторский надзор
2.5.9. Передача документации
2.5.10. РНС
3. Конструктив
...
17.9. Картины, постеры и арт-элементы настенные
17.10. Зеркала

    ...
    <div>
      ...
      <div ref={docRef} className="invoice-print border rounded-lg p-6 bg-white text-black text-sm">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-sm">об оказании услуг по программе монетизации (просмотры контактов)</p>
        ...
        <p className="mb-4">
          ...
          {formatShortDate(periodStart)} по {formatShortDate(invoice.date)} г. обеспечил показ
          контактной информации на Платформе со следующими показателями:
        </p>
        ...
        <table className="w-full border-collapse mb-4">
          <thead>
            <tr className="border-b-2 border-gray-400 text-left text-xs text-gray-600">
              ...
              <th className="py-2 px-2 font-normal">Тип метрики / Просмотры</th>
